...
//Title
    ...
    echo "<div id='course-info'>";
        ...
        //UCAS.
        if (!empty($Display_UCASInstitution)) {
            echo "<h3>UCAS Codes</h3>";
            echo "<p><b>Institution:</b> ".$Display_UCASInstitution."</p>";
            echo "<p><b>Course:</b> ".$Display_UCASCourseCode."</p>";
            echo "<p><b>Campus Code:</b> ".$Display_UCASCCampusCode."</p></div>";
        }
        echo "<h3>HE Study Programme</h3>";
